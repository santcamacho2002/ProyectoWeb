...
/**
 * DTO (Data Transfer Object) para la herramienta para realizar persistencia
 */
public class ToolDTO {
    ...
    /**
     * Constructor vacío de ToolDTO.
     */
    public ToolDTO() {
    }

    /**
     * Constructor de ToolDTO que acepta todos los campos.
     *
     ...
     */
    public ToolDTO(String nombre, String descripcion, String imageUrl, Long idMarca, double precio, String ciudad, int cantidad) {
        this.nombre = nombre;
    ...
    /**
     * Metodo que Metodo que obtiene el nombre de la herramienta.
     *
